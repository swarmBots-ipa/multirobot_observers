...
pose_file = open(current_path + '/json/Poses.json', 'r')
goal_file = open(current_path + '/json/Goals.json', 'r')
...
mlt.savefig(current_path+'/graphs/dotgraph.png')
mlt.legend()
...
plt.savefig(current_path+'/graphs/Polygraph.png')
